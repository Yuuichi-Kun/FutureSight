        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Program Keahlian</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.program-keahlian.update', $programKeahlian->id_program_keahlian) }}" method="POST">
                            ...
                            <select class="form-control @error('id_bidang_keahlian') is-invalid @enderror" 
                                ...
                                @foreach($bidangKeahlian as $bidang)
                                    <option value="{{ $bidang->id_bidang_keahlian }}" 
                                            {{ old('id_bidang_keahlian', $programKeahlian->id_bidang_keahlian) == $bidang->id_bidang_keahlian ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kode_program_keahlian') is-invalid @enderror" 
                                   id="kode_program_keahlian" name="kode_program_keahlian" 
                                   value="{{ old('kode_program_keahlian', $programKeahlian->kode_program_keahlian) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('program_keahlian') is-invalid @enderror" 
                                   id="program_keahlian" name="program_keahlian" 
                                   value="{{ old('program_keahlian', $programKeahlian->program_keahlian) }}">
