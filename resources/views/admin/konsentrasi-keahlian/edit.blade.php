        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Konsentrasi Keahlian</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.konsentrasi-keahlian.update', $konsentrasiKeahlian->id_konsentrasi_keahlian) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <select class="form-control @error('id_program_keahlian') is-invalid @enderror" 
                                ...
                                @foreach($programKeahlian as $program)
                                    <option value="{{ $program->id_program_keahlian }}" 
                                            {{ old('id_program_keahlian', $konsentrasiKeahlian->id_program_keahlian) == $program->id_program_keahlian ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('konsentrasi_keahlian') is-invalid @enderror" 
                                   ...
                                   value="{{ old('konsentrasi_keahlian', $konsentrasiKeahlian->konsentrasi_keahlian) }}">
