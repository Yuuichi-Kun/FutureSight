                ...
                <div class="p-3 card-body p-lg-4">
                    <form method="POST" action="{{ route('alumni.register') }}" class="needs-validation" novalidate>
                        ...
                        <div class="gap-3 text-end d-flex justify-content-end">
                            <a href="{{ route('home') }}" class="px-4 btn btn-secondary btn-lg px-lg-5" style="margin-right: 10px;">
            ...
            <div class="modal-body">
                <div class="mb-3 terms-content">
                    ...
                    <ol>
                        ...
                        <li>Saya memahami bahwa akun saya perlu diverifikasi oleh admin sebelum dapat mengakses fitur lengkap.</li>
